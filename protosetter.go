...
func NewAnalyzer(cfg *Config) *analysis.Analyzer {
	...
	return &analysis.Analyzer{
		Name:  "protosetter",
		Doc:   "Reports direct writes to proto message fields when setters should be used",
		Flags: flags(cfg),
...
func flags(opts *Config) flag.FlagSet {
	fs := flag.NewFlagSet("protosetter", flag.ContinueOnError)
	...
	fs.Func("skip-files", "skip files with the given glob patterns", func(s string) error {
		for pattern := range strings.SplitSeq(s, ",") {
